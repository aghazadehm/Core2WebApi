...
namespace Core2WebApi.LinkServices
{
    public class CommonLinkService : ICommonLinkService
    {
        ...
        {
            var currentPageUriBuilder = new UriBuilder(versionedBaseUri) { Query = pageQueryString };
        ...
        {
            var uriBuilder = new UriBuilder(versionedBaseUri) { Query = pageQueryString };
        ...
        public virtual Link GetCurrentPageLink(Uri uri) => new Link
        {
        ...
        public virtual Link GetPreviousPageLink(Uri uri) => new Link
        {
            Href = uri.AbsoluteUri,
        ...
        public virtual Link GetNextPageLink(Uri uri) => new Link
        {
            Href = uri.AbsoluteUri,
        ...
        public bool ShouldAddPreviousPageLink(int pageNumber) => pageNumber > 1;
        public bool ShouldAddNextPageLink(int pageNumber, int pageCount) => pageNumber < pageCount;
    }
}